...
class PostController extends Controller
{
    ...
    function __construct(PostService $postService)
    {
        ...
        $this->photoLimit = config('const.posts.photoLimit');
        $this->boostedPerPage = config('const.posts.boostedPerPage');
    ...
    public function removePhoto(Post $post, Photo $photo)
    {
        try {
            ...
            if (!in_array($photo->id, $photo_ids)) return $this->errorResponse('fail', 'Wrong Photo!', 422);
